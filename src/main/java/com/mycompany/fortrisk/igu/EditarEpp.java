...
public class EditarEpp extends javax.swing.JFrame {

       Controladora control = null;
       EquipoProteccion epp;
       
    public EditarEpp(int referencia) {
        control = new Controladora();
        initComponents();
        cargarDatos(referencia);
    }
    ...
    private void initComponents() {
        ...
        cmbEquipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Botas", "Casco", "Chaleco", "Gafas" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 432, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtFechaCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 432, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtTalla, javax.swing.GroupLayout.PREFERRED_SIZE, 432, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        String fechaCom = txtFechaCompra.getText();
        String proveedor = txtProveedor.getText();
        String tal = txtTalla.getText();
        String obser = txtObservaciones.getText();
        
        control.modificarEpp(epp, equipo, fechaCom, proveedor, tal, obser);
    ...
    private void cargarDatos(int referencia) {
        this.epp = control.traerEpp(referencia);
        
        if(epp.getEquipo().equals("Botas")){
            cmbEquipo.setSelectedIndex(1);
        }else if(epp.getEquipo().equals("Casco")){
            cmbEquipo.setSelectedIndex(2);
        }else if(epp.getEquipo().equals("Chaleco")){
            cmbEquipo.setSelectedIndex(3);
        }else if(epp.getEquipo().equals("Gafas")){
            cmbEquipo.setSelectedIndex(4);
        }
        
        txtFechaCompra.setText(epp.getFechaCompra());
        txtProveedor.setText(epp.getProveedor());
        txtTalla.setText(epp.getTalla());
        txtObservaciones.setText(epp.getObservaciones());
