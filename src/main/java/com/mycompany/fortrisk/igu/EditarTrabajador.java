...
public class EditarTrabajador extends javax.swing.JFrame {

    Controladora control = new Controladora();
    Empleado empleado;
    
    public EditarTrabajador(int id_trabajador) {
        initComponents();
        cargarDatos(id_trabajador);
    }
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(18, 12, 0, 0);
        jPanel4.add(txtNumDocumento, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(18, 12, 0, 0);
        jPanel4.add(txtDepartamento, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(33, 60, 173, 0);
        jPanel4.add(btnLimpiar, gridBagConstraints);

        btnGuardar.setActionCommand("Enviar");
        ...
        gridBagConstraints.gridy = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(33, 73, 173, 0);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificarEmpleado (empleado, nombre, apellido, numDocumento, departamento, cargo);
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        ListaTrabajador pantalla = new ListaTrabajador();
    ...
    private void cargarDatos(int id_trabajador) {
        this.empleado = control.traerEmpleado(id_trabajador);
        
        txtNombre.setText(empleado.getNombre());
        txtApellido.setText(empleado.getApellido());
        txtNumDocumento.setText(empleado.getNumDocumento());
